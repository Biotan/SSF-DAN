...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt_dir', default='./dataset/Cityscapes/gtFine_trainvaltest/gtFine/val', type=str, help='directory which stores CityScapes val gt images')
    parser.add_argument('--pred_dir', default='./result/cityscapes', type=str, help='directory which stores CityScapes val pred images')
